...
class AbstractWorkerProcess(BaseWorkerProcess):
    ...
    async def _initialize_process_level_resource(self) -> None:
        pass

    async def _destruct_process_level_resource(self) -> None:
        pass
    ...
    def run(self) -> None:
        ...
        try:
            ...
            async def _wrapped_main(
                ...
                await self._initialize_process_level_resource()
                try:
                    ...
                    logging.info("Closing redis clients and pools")
                    await self._destruct_process_level_resource()
    ...
    async def _handle_task(
        ...
        try:
            ...
            job_processor = JobProcessorFactory.new_processor(
                ...
                asset_manager,
                db_session_factory,
                self._remote_redis_io_bound_job_manager,
            )
